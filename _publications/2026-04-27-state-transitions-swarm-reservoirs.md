...
permalink: /publication/2026-04-27-swarm-reservoirs
excerpt: 'We show that simple state transitions can unlock substantial temporal memory in swarm-based reservoir computing, with memory capacity scaling linearly with swarm size across the tested range.'
date: 2026-04-27
...
[Read the paper at PeerJ](https://peerj.com/articles/cs-3763/)

Recommended citation: Lund, T., Adams, A., Aubert-Kato, N., & Ikegami, T. (2026). State transitions unlock temporal memory in swarm-based reservoir computing. <i>PeerJ Computer Science</i>, 12:e3763. https://doi.org/10.7717/peerj-cs.3763
